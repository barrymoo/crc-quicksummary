...
\newcommand{\mysection}[1]{
    \begin{center}
        \pbox{0.8\columnwidth}{}{linewidth=3mm,framearc=0.3,linecolor=pittgold,fillstyle=gradient,gradangle=0,gradbegin=pittblue,gradend=pittblue,gradmidpoint=1.0,framesep=1em}{
            \begin{center}
                \huge\color{white}{\bf{#1}}
            \end{center}
        }
    \end{center}
    \vspace{0.25cm}
...
\begin{multicols}{3}
    ...
    \mysection{Slurm Script Description}
    \Large    
    \begin{center}
        \begin{itemize}
