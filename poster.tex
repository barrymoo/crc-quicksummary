...
\begin{multicols}{3}
    ...
    \begin{center}
        \begin{itemize}
            ...
            \item Submit a Ticket: \\
                \myurl{https://crc.pitt.edu/ticket}
            \item CRC Status: \\
    ...
    \begin{center}
        \begin{itemize}
            ...
            \item Vizualization: \myurl{https://viz.crc.pitt.edu}
            \item Open OnDemand: \myurl{...}
            \item Galaxy: \myurl{...}
            \item CLC Genomics: \myurl{...}
        \end{itemize}
    \end{center}
    ...
    \begin{center}
        \begin{itemize}
            ...
            \begin{itemize}
                \item \code{scp <file> <username>@h2p.crc.pitt.edu:~ # local to remote}
                \item \code{scp <username>@h2p.crc.pitt.edu:~/<file> . # remote to local}
            \end{itemize}
            \item Check your filesystem quotas: \code{crc-quota.py}
            \item Check your service units quotas: \code{crc-usage.pl}
            \item Check the cluster status: \code{crc-sinfo.py}
        \end{itemize}
    \end{center}
    ...
    \begin{center}
        \begin{itemize}
            \item Search all available software: \code{module spider # Use '/' for search, 'q' quits}
